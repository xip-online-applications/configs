module.exports = {
  ...
  rules: {
    ...
    'scss/load-no-partial-leading-underscore': true, // https://github.com/stylelint-scss/stylelint-scss/blob/master/src/rules/load-no-partial-leading-underscore/README.md
